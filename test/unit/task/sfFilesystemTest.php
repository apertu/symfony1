...
$source = $common.'public'.DS.'myplugin';
$target = $common.'plugins'.DS.'myplugin'.DS.'public';
$t->is($filesystem->calculateRelativeDir($source, $target), '..'.DS.'plugins'.DS.'myplugin'.DS.'public', '->calculateRelativeDir() correctly calculates the relative path');

$source = $common.'public'.DS.'myplugin';
$target = $common.'webplugins'.DS.'myplugin'.DS.'public';
$t->is($filesystem->calculateRelativeDir($source, $target), '..'.DS.'webplugins'.DS.'myplugin'.DS.'public', '->calculateRelativeDir() correctly calculates the relative path for dirs that share chars');

$source = $common.'public'.DS.'myplugin';
$target = $common.'public'.DS.'otherplugin'.DS.'sub';
...
$source = $common.'public'.DS.'myplugin';
$target = $common.'public'.DS.'myotherplugin'.DS.'sub';
...
$source = $common.'public'.DS.'myplugin';
$target = $common.'public'.DS.'motherplugin'.DS.'sub';
...
$source = $common.'..'.DS.'public'.DS.'myplugin';
$target = $common.'lib'.DS.'vendor'.DS.'symfony'.DS.'plugins'.DS.'myplugin'.DS.'public';
$t->is($filesystem->calculateRelativeDir($source, $target), '..'.DS.'sfproject'.DS.'lib'.DS.'vendor'.DS.'symfony'.DS.'plugins'.DS.'myplugin'.DS.'public', '->calculateRelativeDir() correctly calculates the relative path for dirs that share chars');
